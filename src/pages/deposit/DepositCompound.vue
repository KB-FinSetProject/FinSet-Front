<template>
  ...
  <div class="deposit-container">
    ...
    <div class="tabs-container">
      ...
      <router-link to="/depositsimple" class="tab" active-class="active" @click="fetchDeposits('simple')" style="color: #DADADA;">단리</router-link>
...
export default {
  ...
  mounted() {
    this.fetchDeposits('compound'); // 컴포넌트가 마운트될 때 단리 상품 데이터 가져오기
  },
};
</script>
