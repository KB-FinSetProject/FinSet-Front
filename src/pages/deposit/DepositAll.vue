<template>
  ...
  <div class="deposit-container">
    ...
    <div class="tabs-container">
      ...
      <router-link to="/depositsimple" class="tab" active-class="active" style="color: #DADADA;">단리</router-link>
...
export default {
  ...
  methods: {
    ...
    getImg(imgUrl) {
      return imgUrl ? `src${imgUrl}` : 'src/assets/default-image.png'; // 기본 이미지 경로
    },
    setActiveTab(tab) {
      this.activeTab = tab; // 활성 탭 상태 업데이트
    },
  },
  mounted() {
