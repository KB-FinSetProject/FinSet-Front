<template>
  ...
  <div class="survey-container">
    ...
    <br>
    <h2 class="question">5. 현재 투자하고자 하는 자금은 전체 <br>&nbsp;&nbsp;&nbsp;&nbsp;금융자산(부동산 등을 제외) 중 어느 <br>&nbsp;&nbsp;&nbsp;&nbsp;정도의 비중을 차지합니까?</h2>
    <br>
    ...
    <div class="navigation">
      <h4 class="text-md-center" style="color: #60584C;">5/7</h4>
